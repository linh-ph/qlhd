...
urlpatterns = [
    ...
    path('admin-invoices', views.admin_invoices_view,name='admin-invoices'),
    path('admin-add-product', views.admin_add_product_view,name='admin-add-product'),
    path('admin-add-invoice', views.admin_add_invoice_view,name='admin-add-invoice'),
    path('delete-product/<int:pk>', views.delete_product_view,name='delete-product'),
    path('update-product/<int:pk>', views.update_product_view,name='update-product'),
    path('update-invoice/<int:pk>', views.update_invoice_view,name='update-invoice'),    
