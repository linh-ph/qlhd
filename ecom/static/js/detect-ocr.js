        ...
        setTimeout(function() {
          //your code to be executed after 1 second
            if (response.error) {
                ...
                $('#export_excel').attr('href',"/api/csv/"+response.data.id_late)
                // show info
                ...
                closeLoading("Thông báo","Message: "+ response.message + "<br/> Thời gian : "+ Number(response.data.timer_final).toFixed(2) + "s", response.error);
            }
        }, delayInMilliseconds);
    },
