from api.src.utils.pre_processing_util import get_coordinates_mask
import cv2
from api.src.assets import TEMPLATE_1_TABLE_PATH, TEMPLATE_2_TABLE_PATH, TEMPLATE_3_TABLE_PATH, TEMPLATE_4_TABLE_PATH, \
