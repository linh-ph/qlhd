...
from qlhd.api.utils.util_image import CONFIG_STRING, CONFIG_STRING_SINGE_CHAR, CONFIG_DECIMAL, KERNEL, KERNEL_MOR, \
    CONFIG_NUMBER
...
class MyThread(Thread):
    ...
    def run(self):
        for j, col_value in enumerate(self.row_value):
            ...
            elif self.label[j] == "price" or self.label[j] == "total_price" or self.label[j] == "tax_money" or \
                    self.label[j] == "total":
